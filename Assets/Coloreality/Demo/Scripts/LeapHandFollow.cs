    	...
    	void FixedUpdate () {
			...
			if (cManager.Leap.Data != null) {
				...
				for (int i = 0; i < hands.Count; i++) {
                    ...
                    handObjects[curSide].transform.localPosition = hands[i].PalmPosition.ToScaledVector3();
                    //handObjects[curSide].transform.localRotation = hands[i].Rotation.ToHMDQuaternion ();
                    handObjects[curSide].transform.localRotation = hands[i].Rotation.ToQuaternion();
                }
